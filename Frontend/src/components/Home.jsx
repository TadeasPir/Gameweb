...
const Home = () => {
  ...
  const toRotate = [ "are Game Developer", "are 3D masters", "use Unity game engine" ];
  const period = 2000;
  ...
  <Container>
    <Row className="align-items-center">
      ...
      <p>Welcome to TSL, an independent game development studio driven by passion, creativity, and innovation. Our team of dedicated developers, artists, and storytellers work tirelessly to craft unique and immersive gaming experiences. We believe in pushing the boundaries of interactive entertainment, blending compelling narratives with captivating gameplay.
      <br/>
